...
// All URLs valid ~7 days. Swap photo URLs for permanent hosted images later.

export const assets = {
  // KLM logo: used as CSS mask-image over a white div (same technique as Figma)
  ...
  // "new destination" badge elements
